...
public class ObjetosDados {
    ...
    //metodo para obeter todos os dados do bando de dados;
    public ObjetosDados (String url) throws SQLException{
        Connection conexao = DriverManager.getConnection(url);
        obterContasStm = conexao.prepareStatement("SELECT * FROM contas");
        adicionarStm = conexao.prepareStatement("INSERT INTO contas VALUE (?,?)");
