...
public class App {
    ...
    private static ObjetosDados objDados = null;
    ...
    public static void main(String[] args) throws Exception {
        String url = "jdbc:postgresql://aws-0-sa-east-1.pooler.supabase.com:6543/postgres?user=postgres.exstkerxnfbtqxaxllfg&password=Pedro@2004";
        objDados = new ObjetosDados(url);
        boolean sair = false;
        while (!sair) {
